...
add_action( 'admin_menu', 'uio_add_plugin_page' );
add_action( 'admin_init', 'uio_page_init' );

/**
 * Add the settings page to the dashboard menu.
 */
function uio_add_plugin_page() {
	add_options_page(
		'UIO Settings',
		'User Interface Options',
		'manage_options',
		'uio-setting-admin',
		'uio_create_admin_page'
	);
}
...
function uio_page_init() {
	...
	add_settings_section(
		...
		'Settings', // Title.
		'uio_print_section_info', // Callback.
...
/**
 * Display general information at the start of the settings section.
 */
function uio_print_section_info() {
 ...
 */
function uio_create_admin_page() {
